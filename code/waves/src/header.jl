...
global const rho_refS = OffsetArray(@fortGetArr("rho_refs", rc_kind, (NK + 2)), 0:NK+1)
global const rho_refN = OffsetArray(@fortGetArr("rho_refn", rc_kind, (NK + 2)), 0:NK+1)
global const rho_refB = OffsetArray(@fortGetArr("rho_refb", rc_kind, (NJ + 2)), 0:NJ+1)
...
global const dyM = OffsetArray(@fortGetArr("dym", rc_kind, (NJ+2)), 0:NJ+1)
