function cpfine(dtimel,cpf,fn)
    ...
    for i in 1:NI
        for j in 2:NJ-1
            for k in 2:NK-1
                fn[i, j, k] = edt * (cxf[i+1, j, k] - cxf[i, j, k] + cyf[i, j+1, k] - cyf[i, j, k] + czf[i, j, k+1] - czf[i, j, k]
                                    - (skfc[i+1, j+1, k+1] - skfc[i+1, j+1, k])
                                    + (sifc[i+1, j, k] - sifc[i, j, k])
                                    + (sjfc[i, j+1, k] - sjfc[i, j, k]))
                ...
                cpf[6, i, j, k] = gqk[i+1, j+1, k+1, 3] + 0.25e0 * (gqi3[i+1, j, k] - gqi3[i, j, k] + gqj3[i, j+1, k] - gqj3[i, j, k])
                cpf[7, i, j, k] = gqk[i+1, j+1, k, 3] + 0.25e0 * (- gqi3[i+1, j, k] + gqi3[i, j, k] - gqj3[i, j+1, k] - gqj3[i, j, k])
                ...
                cpf[12, i, j, k] = 0.25e0 * (gqi3[i, j, k] + gqk[i+1, j+1, k, 1])
                cpf[13, i, j, k] = 0.25e0 * (-gqi3[i+1, j, k] - gqk[i+1, j+1, k, 1])
                cpf[14, i, j, k] = 0.25e0 * (gqi3[i+1, j, k] + gqk[i+1, j+1, k+1, 1])
                cpf[15, i, j, k] = 0.25e0 * (-gqi3[i, j, k] - gqk[i+1, j+1, k+1, 1])
                cpf[16, i, j, k] = 0.25e0 * (gqj3[i, j, k] + gqk[i+1, j+1, k, 2])
                cpf[17, i, j, k] = 0.25e0 * (-gqj3[i, j+1, k] - gqk[i+1, j+1, k, 2])
                cpf[18, i, j, k] = 0.25e0 * (gqj3[i, j+1, k] + gqk[i+1, j+1, k+1, 2])
                cpf[19, i, j, k] = 0.25e0 * (-gqj3[i, j, k] - gqk[i+1, j+1, k+1, 2])
            end
        end
    end
